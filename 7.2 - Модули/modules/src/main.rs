...
//--------------------------------------------------------------------------------
// Распределение модулей по отдельным файлам
//--------------------------------------------------------------------------------

// Содержимое модуля transport определено в отдельном файле "transport.rs". Наличие ';' после
// mod transport указывает компилятору Rust на то, что содержимое этого модуля необходимо искать в
// другом файле, название которого совпадает с названием этого модуля.
mod transport;
