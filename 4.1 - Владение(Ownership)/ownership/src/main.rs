fn main() {
    ...
    // Область видимости - это места в программе, внутри которых элемент является валидным.
    // В Rust(как и во многих других языках) переменная становится видна с момента её
